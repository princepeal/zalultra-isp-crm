...
class BDSmartPayService extends CustomSmsServices
{
    /**
    ...
    protected function sendCustomSMS($smsData, $smsAttributes): array
    {
        ...
        $apiUrl = 'http://bdsmartpay.com/sms/smsapi.php';
        $params = [
...
/**
 * Usage: Set gateway_name = 'custom_sms', sms_service_name = 'BDSmartPayService'
